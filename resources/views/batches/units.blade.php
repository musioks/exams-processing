...
@section('crumbs')
    ...
    <li class="breadcrumb-item"><a href="{{url('/academics/batches')}}">Batches</a></li>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('/academics/batches/'.$batch->id.'/units') }}" method="post">
                                    @csrf
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="{{ url('/academics/batches/'.$batch->id.'/units/detach/'.$row->id) }}"
